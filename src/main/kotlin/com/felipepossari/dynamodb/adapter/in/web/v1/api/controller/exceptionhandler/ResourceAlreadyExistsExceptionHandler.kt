...
@Produces
@Singleton
class ResourceAlreadyExistsExceptionHandler : ExceptionHandler<ResourceAlreadyExistsException, HttpResponse<*>> {

    companion object{
        private val logger: Logger = LoggerFactory.getLogger(this::class.qualifiedName)
    }

    override fun handle(request: HttpRequest<*>, exception: ResourceAlreadyExistsException): HttpResponse<*> {
        logger.warn("Resource already exists exception handler executed")
